...
int divide(char *nazwa_pliku_in, unsigned char reszta[], unsigned char wielomian[])
{
...
void appendCrcToFile2(char * inputWithZeroes, char * outputWithCrc, int crcSizeInBytes, unsigned char crc[])
{
